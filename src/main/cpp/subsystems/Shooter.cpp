...
void Shooter::wall()
{
    if (isHigh)
    {
        ...
        flyWheelLead_pidController.SetReference(1968, rev::CANSparkMaxLowLevel::ControlType::kVelocity);
